  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-[#6b2d11] mb-6">How SkilledLink Works</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            <Search className="w-16 h-16 text-[#a0522d] mb-4" />
            <h2 className="text-2xl font-semibold text-[#a0522d] mb-3">1. Find Your Artisan</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <h2 className="text-2xl font-semibold text-[#a0522d] mb-3">2. Connect & Book</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            <ShieldCheck className="w-16 h-16 text-[#a0522d] mb-4" />
            <h2 className="text-2xl font-semibold text-[#a0522d] mb-3">3. Get it Done!</h2>
        ...
        <div className="mt-12 text-center">
          <h2 className="text-3xl font-bold text-[#6b2d11] mb-4">Join Our Community</h2>
          ...
          <div className="flex justify-center gap-4">
            ...
            <a href="/" className="inline-block border border-[#f5d4aa] text-[#6b2d11] px-8 py-3 rounded-md text-lg font-medium hover:bg-[#f5d4aa] hover:text-white transition duration-300">
              Find a Service
            </a>
          </div>
        </div>
