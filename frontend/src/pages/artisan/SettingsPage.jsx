...
import { User, Lock, Eye, EyeOff, Camera, Wrench } from 'lucide-react';
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-[#a0522d] focus:border-[#151E3D] transition-colors resize-none"
                      />
                    </div>
                  </div>
                </div>
