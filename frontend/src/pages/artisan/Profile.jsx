...
import { User, CheckCircle, XCircle, Clock, Star } from 'lucide-react'; // Import icons
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          {user?.role === 'artisan' && (
            <button
              ...
              disabled={loading}
              className="bg-[#151E3D] text-white px-4 py-2 rounded-lg hover:bg-[#1E2A4A] disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
        ...
        {error && (
          <div className="bg-white shadow-lg rounded-lg p-8 max-w-3xl mx-auto text-center">
            ...
            <button 
              ...
              className="bg-[#151E3D] text-white px-4 py-2 rounded hover:bg-[#1E2A4A]"
            >
              Retry
            </button>
          </div>
