  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-[#151E3D] mb-6">About SkilledLink</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            <Users className="w-16 h-16 text-[#151E3D] mb-4" />
            <h2 className="text-2xl font-semibold text-[#151E3D] mb-3">Our Mission</h2>
            <p className="text-gray-600">To empower skilled individuals and provide seamless access to reliable services for everyone.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            <Lightbulb className="w-16 h-16 text-[#151E3D] mb-4" />
            <h2 className="text-2xl font-semibold text-[#151E3D] mb-3">Our Vision</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
            ...
            <h2 className="text-2xl font-semibold text-[#151E3D] mb-3">Our Values</h2>
