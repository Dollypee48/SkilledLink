            ...
            <div className="lg:col-span-1">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6 sticky top-8">
                ...
                <nav className="space-y-3">
                  ...
                  >
                    <div className={`p-2 rounded-lg mr-3 transition-all duration-300 ${
                      activeTab === 'kyc' ? 'bg-white/20' : 'bg-gray-100 group-hover:bg-blue-100'
                    }`}>
                      <Shield className="w-5 h-5" />
                    </div>
                  ...
                  >
                    <div className={`p-2 rounded-lg mr-3 transition-all duration-300 ${
                      activeTab === 'report' ? 'bg-white/20' : 'bg-gray-100 group-hover:bg-blue-100'
                    }`}>
                      <AlertTriangle className="w-5 h-5" />
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
                      <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-6">
                          Complete your KYC verification to unlock all platform features and build trust with artisans.
                        </p>
                        <button
                          onClick={() => window.location.href = '/kyc-verification'}
                          className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#151E3D] to-[#1E2A4A] text-white font-semibold rounded-lg hover:from-[#1E2A4A] hover:to-[#151E3D] transition-all duration-300 shadow-lg hover:shadow-xl"
                        >
                  ...
                  <div className="p-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
                      <div className="text-center">
                        ...
                        <button
                          onClick={() => window.location.href = '/customer-report'}
